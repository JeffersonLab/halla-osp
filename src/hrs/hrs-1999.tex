...
An absolute cross section accuracy of upto $\sim$ 1\% is 
...
which can be extremely dangerous do to the size and stored energy in the systems. 
...
windows.   During hall maintainance, covers are placed over the windows
