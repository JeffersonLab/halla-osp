...
\footnote{
  $CVS~revision~ $Id: nmr-1999.tex,v 1.3 2003/12/13 06:23:38 gen Exp $ $ 
}
\footnote{Authors: J.LeRose \email{lerose@jlab.org}}
}

The field-monitoring controls are available using the main 
HRS screen (see Figure~\ref{fig:hrs_mag_cntrl}).
...
% ===========  CVS info
% $Header: /group/halla/analysis/cvs/tex/osp/src/hrs/nmr-1999.tex,v 1.3 2003/12/13 06:23:38 gen Exp $
% $Id: nmr-1999.tex,v 1.3 2003/12/13 06:23:38 gen Exp $
% $Author: gen $
