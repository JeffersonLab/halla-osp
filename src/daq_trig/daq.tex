...
\footnote{
  $CVS~revision~ $Id: daq.tex,v 1.5 2003/11/17 06:49:00 gen Exp $ $
}
...
% ===========  CVS info
% $Header: /group/halla/analysis/cvs/tex/osp/src/daq_trig/daq.tex,v 1.5 2003/11/17 06:49:00 gen Exp $
% $Id: daq.tex,v 1.5 2003/11/17 06:49:00 gen Exp $
% $Author: gen $
