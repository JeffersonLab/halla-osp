...
\footnote{
  $CVS~revision~ $Id: daq.tex,v 1.7 2003/12/13 06:23:37 gen Exp $ $
}
...
% ===========  CVS info
% $Header: /group/halla/analysis/cvs/tex/osp/src/daq_trig/daq.tex,v 1.7 2003/12/13 06:23:37 gen Exp $
% $Id: daq.tex,v 1.7 2003/12/13 06:23:37 gen Exp $
% $Author: gen $
