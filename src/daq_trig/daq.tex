...
\footnote{
  $CVS~revision~ $Id: daq.tex,v 1.8 2003/12/17 03:59:48 gen Exp $ $
}
...
% ===========  CVS info
% $Header: /group/halla/analysis/cvs/tex/osp/src/daq_trig/daq.tex,v 1.8 2003/12/17 03:59:48 gen Exp $
% $Id: daq.tex,v 1.8 2003/12/17 03:59:48 gen Exp $
% $Author: gen $
