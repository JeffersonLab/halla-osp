...
\footnote{
  $CVS~revision~ $Id: trigger.tex,v 1.4 2003/08/01 20:34:06 rom Exp $ $
}
...
First login to the ADAQ Linux box adaql1 or adaql2 
(and no others) as ``atrig'' account.   (E.g. ssh adaql1 -l atrig).   
The Run Coordinator should know the password.  
Type ``trigsetup''.   A self-explanatory graphical user 
...
then type ``trigsetup mapfile'' where mapfile is 
the name of the trigger map file.   Some examples 
of map files are in /home/atrig/trigger, see 
trigger\_left.map and trigger\_right.map for the 
...
% $Header: /group/halla/analysis/cvs/tex/osp/src/daq_trig/trigger.tex,v 1.4 2003/08/01 20:34:06 rom Exp $
% $Id: trigger.tex,v 1.4 2003/08/01 20:34:06 rom Exp $
% $Author: rom $
