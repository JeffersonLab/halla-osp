...
\footnote{
  $CVS~revision~ $Id: online-analysis.tex,v 1.3 2003/11/17 06:49:00 gen Exp $ $
}
...
\subsection{Analysis using ESPACE or C++ Analyzer}
...
Dataspy and Dhist are somewhat obsolete
online diagnostic programs.  It remains to
be seen if we replace these by an offshoot of
the C++ analyzer.
The purposes of dataspy and dhist are: 
...
the executable \mycomp{dplot}.  
For some online help, simply type
\mycomp{dataspy} or \mycomp{dplot}.
...
% ===========  CVS info
% $Header: /group/halla/analysis/cvs/tex/osp/src/daq_trig/online-analysis.tex,v 1.3 2003/11/17 06:49:00 gen Exp $
% $Id: online-analysis.tex,v 1.3 2003/11/17 06:49:00 gen Exp $
% $Author: gen $
