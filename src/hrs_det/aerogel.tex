...
\footnote{
  $CVS~revision~ $Id: aerogel.tex,v 1.7 2003/11/22 21:23:48 bogdanw Exp $ $
}
\footnote{Author: B. B. Wojtsekhowski \url{mailto:bogdanw@jlab.org}}
}
\hskip .3 in There three threshold \v{C}erenkov counters with the aerogel radiator 
available for installation in HRS. At least two can be installed in one HRS.
The first of them, built by Regina university, is described in the next section. 
Two other, built by JLab/FIU/MIT collaboration, are presented also.
...
%
\begin{figure}[p]
\includegraphics[angle=0,width=15cm]{scint_fig4}
