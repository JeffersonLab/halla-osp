%\author{B.B. Wojtsekhowski}
%\address{Physics Dept. TJNAF}

\section[Aerogel \Cerenkov Counter]{Aerogel \Cerenkov Counters
\footnote{
  $CVS~revision~ $Id: aerogel.tex,v 1.8 2003/11/23 23:02:01 bogdanw Exp $ $
}
...
The first counter (AM) contains hygroscopic aerogel~\cite{Airglass}
...
number of photo-electrons is about 7.3~\cite{mirraero}.

The next two counters (A1 and A2)~\cite{a1a2} are diffusion-type aerogel counters.
The diffusion technique for light collection in aerogel \v{C}erenkov detectors
was evaluated in Refs.~\cite{perrino,lagamda,iommi}.
%
A1 has 24 PMTs (Burle 8854). The 9 cm thick aerogel radiator used in A1~\cite{Matsu}
...
(XP4572B1~\cite{Photonis}).
The aerogel in A2~\cite{Matsu} has a refraction index of 1.055, giving 
a threshold of 2.8 (0.415) GeV/$c$ for protons (pions). 
The thickness of the aerogel radiator in A2 is 5 cm, producing an average
number of about 30 photo-electrons for GeV electrons~\cite{a1a2}.

%\author{G.J. Lolos}
%\address{Dept. of Physics, University of Regina, Regina, SK, S4S 0A2 Canada}

\subsection[Mirror Aerogel \Cerenkov Counter]{Mirror Aerogel \Cerenkov Counter
\footnote{
  $CVS~revision~ $Id: aerogel.tex,v 1.8 2003/11/23 23:02:01 bogdanw Exp $ $
}
...
It is a silica aerogel \v{C}erenkov counter of the compact reflection mirror design, 
...
The PMTs chosen for the counter were Burle model number 8854, 127 $mm$ photocathode 
...
%
\begin{figure}[p]
\includegraphics[angle=0,width=12cm]{scint_fig4}
...
%
\begin{figure}[p]
\includegraphics[angle=0,width=12cm]{a2_PMT_box1.jpg}
...
%
\begin{figure}[p]
\includegraphics[angle=0,width=12cm]{a1_inside.jpg}
...
%
\begin{figure}[p]
\includegraphics[angle=0,width=15cm]{A1_scheme.pdf}
\caption[The scheme of A1 detector] {The scheme of A1 detector.}
\label{fig:A1_scheme}
\end{figure}
%
\begin{figure}[p]
\includegraphics[angle=0,width=15cm]{A2_scheme.pdf}
\caption[The scheme of A2 detector] {The scheme of A2 detector.}
\label{fig:A2_scheme}
\end{figure}
%
\begin{figure}[p]
\includegraphics[angle=0,width=15cm]{diff_aero.pdf}
