...
\footnote{
  $CVS~revision~ $Id: aerogel.tex,v 1.4 2003/06/06 21:41:39 gen Exp $ $
}
...
\begin{table}
\caption[Aerogel:the number of photoelectrons]{
...
9B            & 0.5 & & \\
\end{tabular}
\caption[Aerogel:photoelectrons]{As in table \ref{tab:aero_tab1}, but for the center hit location configuration.}
\label{tab:aero_tab2}
\end{table}
...
% ===========  CVS info
% $Header: /group/halla/analysis/cvs/tex/osp/src/hrs_det/aerogel.tex,v 1.4 2003/06/06 21:41:39 gen Exp $
% $Id: aerogel.tex,v 1.4 2003/06/06 21:41:39 gen Exp $
% $Author: gen $
% $Date: 2003/06/06 21:41:39 $
% $Name:  $
% $Locker:  $
% $Log: aerogel.tex,v $
% Revision 1.4  2003/06/06 21:41:39  gen
