...
\footnote{
  $CVS~revision~ $Id: aerogel.tex,v 1.6 2003/11/21 17:14:30 bogdanw Exp $ $
}
\footnote{Author: B. B. Wojtsekhowski \url{mailto:bogdanw@jlab.org}}
}
\hskip .5 in There three threshold Cherenkov counters with the aerogel radiator 
...
It is a silica aerogel \Cerenkov counter of the compact reflection mirror design, which was 
