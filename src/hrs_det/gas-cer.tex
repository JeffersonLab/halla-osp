...
%
\begin{figure}[p]
\includegraphics[angle=0,width=14cm]{gas_cer_fig1.jpg}
...
%
\begin{figure}[p]
\includegraphics[angle=0,width=10cm]{gas_cer_fig3.jpg}
...
%
\begin{figure}[p]
\includegraphics[angle=0,width=10cm]{gas_cer_fig2.jpg}
...
The high voltage has to be adjust in order to have for each PMT 
