...
\infolevtwo{
  ...
  \begin{figure}[p]
    \begin{center}
%\begin{latexonly}
      \includegraphics[angle=90.0,height=.8\textheight]{medm_halla_hv_rhrs3}
%end{latexonly}
\html{
  ...
  \begin{figure}[p]
    \begin{center}
%\begin{latexonly}
      \includegraphics[angle=90.0,height=.8\textheight]{medm_halla_hv_card}
%end{latexonly}
\html{
...
\clearpage
  ...
  outdoors is supplied to the housing at a slight over-pressure. A diagram
  of the PMT housing for the S2 is shown in Figure~\ref{fig:s2_pmt_housing}.
}
...
% ===========  CVS info
% $Header: /group/halla/analysis/cvs/tex/osp/src/hrs_det/scin.tex,v 1.5 2003/11/11 21:15:48 feuerbac Exp $
% $Id: scin.tex,v 1.5 2003/11/11 21:15:48 feuerbac Exp $
% $Author: feuerbac $
% $Date: 2003/11/11 21:15:48 $
% $Name:  $
% $Locker:  $
% $Log: scin.tex,v $
