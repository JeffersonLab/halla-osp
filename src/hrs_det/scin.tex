...
\section[Trigger Scintillator Counters]{Trigger Scintillator Counters
  \footnote{
    $CVS~revision~ $Id: scin.tex,v 1.6 2003/11/12 20:26:11 feuerbac Exp $ $
  }
...
channel, and supported from the PMT housings. Figure ~\ref{fig:s1mount}
shows the mounting scheme for S1. Signals from the PMTs are sent to Camac
...
\infolevone{
  ...
  The geometry of S0 counter limits its timing resolution. The HV In 1999
...
% ===========  CVS info
% $Header: /group/halla/analysis/cvs/tex/osp/src/hrs_det/scin.tex,v 1.6 2003/11/12 20:26:11 feuerbac Exp $
% $Id: scin.tex,v 1.6 2003/11/12 20:26:11 feuerbac Exp $
% $Author: feuerbac $
% $Date: 2003/11/12 20:26:11 $
% $Name:  $
% $Locker:  $
% $Log: scin.tex,v $
