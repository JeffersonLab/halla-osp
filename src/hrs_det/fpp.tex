...
\footnote{
  $CVS~revision~ $Id: fpp.tex,v 1.3 2003/06/06 17:00:27 gen Exp $ $
}
...
\vfill\eject
% ===========  CVS info
% $Header: /group/halla/analysis/cvs/tex/osp/src/hrs_det/fpp.tex,v 1.3 2003/06/06 17:00:27 gen Exp $
% $Id: fpp.tex,v 1.3 2003/06/06 17:00:27 gen Exp $
% $Author: gen $
