%\vfill\eject
%\newpage
\section{The Focal Plane Polarimeter}
...
\vfill\eject
% ===========  CVS info
% $Header: /group/halla/analysis/cvs/tex/osp/src/hrs_det/fpp.tex,v 1.2 2003/06/05 23:30:01 gen Exp $
% $Id: fpp.tex,v 1.2 2003/06/05 23:30:01 gen Exp $
% $Author: gen $
...
{\small
\begin{verbatim}CVS $Id: fpp.tex,v 1.2 2003/06/05 23:30:01 gen Exp $\end{verbatim}
}
