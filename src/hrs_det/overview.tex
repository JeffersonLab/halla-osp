...
\footnote{Authors: B.B.Wojtsekhowski \email{bogdanw@jlab.org}}
}
...
The configurations can be modified to meet experimental needs, for example
the short gas Cherenkov counter can be made longer to increase the pion
rejection, the two aerogel counters can be installed on one spectrometer,
an additional CH2 analyzer for FPP can be added and so on. The locations of
the VDC, S1, and shower detectors are fixed, but some of the other detectors 
can be moved.
...
% ===========  CVS info
% $Header: /group/halla/analysis/cvs/tex/osp/src/hrs_det/overview.tex,v 1.12 2005/04/04 22:27:25 gen Exp $
% $Id: overview.tex,v 1.12 2005/04/04 22:27:25 gen Exp $
% $Author: gen $
...
%
% Revision 1.11  2003/12/17 03:59:48  gen
