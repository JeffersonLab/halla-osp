...
\label{sec:platform}   
  ...
  The scripts and Makefile did no work - at least without
...
\label{sec:latexfiles}
  ...
  \begin{list}{}{\setlength{\itemsep}{-0.15cm}}
    ...
    \item \mycomp{people/} - the targets' description.
  \end{list}
...
% ===========  CVS info
% $Header: /group/halla/analysis/cvs/tex/osp/src/doc/main.tex,v 1.1 2003/06/05 17:28:33 gen Exp $
% $Id: main.tex,v 1.1 2003/06/05 17:28:33 gen Exp $
% $Author: gen $
