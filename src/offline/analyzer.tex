...
\chapter[C++ Analyzer]{C++ Analyzer
\footnote{
  $CVS~revision~ $Id: analyzer.tex,v 1.4 2003/12/13 06:23:39 gen Exp $ $
}
\footnote{Authors: J.-O.\ Hansen \email{ole@jlab.org}}
}
...
ROOT~\cite{ROOTcern} programming
...
the beamline instrumentation, scaler and EPICS~\cite{EPICSwww} slow control data, and 
helicity information. The event decoder is compatible with the CODA~\cite{CODAwww}
...
% ===========  CVS info
% $Header: /group/halla/analysis/cvs/tex/osp/src/offline/analyzer.tex,v 1.4 2003/12/13 06:23:39 gen Exp $
% $Id: analyzer.tex,v 1.4 2003/12/13 06:23:39 gen Exp $
% $Author: gen $
% $Date: 2003/12/13 06:23:39 $
% $Name:  $
% $Locker:  $
% $Log: analyzer.tex,v $
% Revision 1.4  2003/12/13 06:23:39  gen
% Septum added. Name tables. Polishing
%
% Revision 1.3  2003/12/05 07:24:18  gen
% Polishing
%
