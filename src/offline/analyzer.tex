...
\footnote{
  $CVS~revision~ $Id: analyzer.tex,v 1.5 2003/12/17 03:59:49 gen Exp $ $
}
...
\begin{namestab}{tab:offline:personnel}{Offline analysis: authorized personnel}{%
...
% ===========  CVS info
% $Header: /group/halla/analysis/cvs/tex/osp/src/offline/analyzer.tex,v 1.5 2003/12/17 03:59:49 gen Exp $
% $Id: analyzer.tex,v 1.5 2003/12/17 03:59:49 gen Exp $
% $Author: gen $
