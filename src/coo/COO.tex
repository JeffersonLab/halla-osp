...
\item Tritium Target Awareness Training (SAF110T) 
...
\bf{NOTE: } For the triton experiments, changes of state of the Hall from controlled
to restricted access must go through Dave Meekins.   Changes between beam permit and
controlled may be called by the shift leader; though only as part of the run plan and/or
coordinating with the run coordinator.
