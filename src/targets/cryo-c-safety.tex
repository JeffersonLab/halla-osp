\section[Cryogenic Hydrogen and Deuterium Targets]{Cryogenic Hydrogen and Deuterium Targets
\footnote{
  $CVS~revision~ $Id: cryo-c-safety.tex,v 1.4 2003/12/13 06:23:39 gen Exp $ $
}
\footnote{Authors: Dr.No \email{????@jlab.org}}
}

The Hall A cryogenic target system
consists of two completely instrumented targets, H$_2$ and D$_2$. In addition
a third target loop is installed in the scattering chamber
but this target is not usually connected to a full gas handling system.
This third loop is used as a helium target.

The hydrogen and deuterium targets present a number of potential
hazards, such as the
fire/explosion hazard of the flammable gas as well as the hazards
connected with
the vacuum vessel and the of handling cryogenic liquids
(ODH and high pressure). In this document the hydrogen target will be referred
...
Additional documentation on the targets and the target controls
is available from J.P.~Chen. In particular, ~reference \cite{bi:tgts} is
highly recommended.
...
% ===========  CVS info
% $Header: /group/halla/analysis/cvs/tex/osp/src/targets/cryo-c-safety.tex,v 1.4 2003/12/13 06:23:39 gen Exp $
% $Id: cryo-c-safety.tex,v 1.4 2003/12/13 06:23:39 gen Exp $
% $Author: gen $
% $Date: 2003/12/13 06:23:39 $
% $Name:  $
% $Locker:  $
% $Log: cryo-c-safety.tex,v $
