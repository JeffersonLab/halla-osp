...
The main components of the target system (see Fig.~\ref{fig:wt_uno}
 \infolevtwo{and Fig.~\ref{fig:wt_uno-mau}} 
) are: 
\begin{itemize}
...
\infolevfour{ (Fig.~\ref{fig:wt_thfoil})}.
Under the cell, a
target holder allows one to put up to 5 solid targets cooled by the
water% 
\infolevfour{ (Fig.~\ref{fig:wt_target-stack})}.
...
The EPICS crate 
\infolevtwo{ (Fig.~\ref{fig:wt_crate})}
...
\infolevtwo{The control equipment is mounted in a rack
 (see Fig.~\ref{fig: wt_control rack}).} 
The user interface (GUI)%
\infolevtwo{ (Fig.~\ref{fig:wt_GUI})}
is based on MEDM\cite{MEDMwww}\footnote{
  The software is maintained by David Wetherholt \url{mailto:wether@jlab.org} 
...
% ===========  CVS info
% $Header: /group/halla/analysis/cvs/tex/osp/src/targets/waterfall-target.tex,v 1.4 2003/11/21 18:13:11 gen Exp $
% $Id: waterfall-target.tex,v 1.4 2003/11/21 18:13:11 gen Exp $
% $Author: gen $
% $Date: 2003/11/21 18:13:11 $
% $Name:  $
% $Locker:  $
