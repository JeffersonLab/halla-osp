...
\footnote{
  $CVS~revision~ $Id: pol-he3.tex,v 1.17 2008/08/04 13:03:58 jpchen Exp $ $
}
...
The laser light for this experiment is provided by ten 30 Watt, 795
...
enclosure with the enclosure windows.  The beam inlet
...
to approximately 7.2 Amps of current and 28 Volts in the horizontal coils 
...
corresponds to 9.2 Amps and 36 Volts in the horizontal coils and 9.5 Amps
and 42 Volts in the vertical coils. The maximum field will not exceed
35 Gauss, which corresponding to 10.0 Amps and 39 Volts for the horizontal coils 
and 10.4 Amps and 46 Volts for the vertical coils.

The horizontal coils are controlled by a DC voltage from two Stanford Research
...
\item Administrative controls:
 ...
 \item Voltage to be used is not to exceed 48 V.
 \end{itemize}
\end{itemize}
...
%They can also be used to compensate for field gradient to minimize AFP
%polarization loss.
...
\begin{itemize}
\item{Turn off the lasers, rotate the magnetic holding
field to the parallel configuration (if the field is in transverse or vertical 
mode).}
...
The optical setup is shown in Fig.~\ref{fig:laser_hall}, and is made of:
\begin {itemize}
...
% ===========  CVS info
% $Header: /group/halla/analysis/cvs/tex/osp/src/targets/pol-he3.tex,v 1.17 2008/08/04 13:03:58 jpchen Exp $
% $Id: pol-he3.tex,v 1.17 2008/08/04 13:03:58 jpchen Exp $
% $Author: jpchen $
% $Date: 2008/08/04 13:03:58 $
% $Name:  $
% $Locker:  $
% $Log: pol-he3.tex,v $
