...
\footnote{
  $CVS~revision~ $Id: pol-he3.tex,v 1.27 2008/09/02 15:08:39 jpchen Exp $ $
}
\footnote{Authors: Revised by: T. Averett, J. P. Chen, C. Dutta, Y. Qiang. earlier versions: 
...
RF: ON
Source:External DC
Dev: 20 KHz and so on
Gain: $-5$dB (but range is from 0 to $-10$ dB depending on the sintuation)
...
\item Set the step sizeto 0.01 MHz for a quick scan. Or 0.005 MHz for a 
nominal scan.
...
\item Lets just not care about the phase of the lock in now.
...
\item RUN it. SET the DEFAULT parameters. Freq. 78 to 92 KHz. V\_rms to 0.8 V.
...
% ===========  CVS info
% $Header: /group/halla/analysis/cvs/tex/osp/src/targets/pol-he3.tex,v 1.27 2008/09/02 15:08:39 jpchen Exp $
% $Id: pol-he3.tex,v 1.27 2008/09/02 15:08:39 jpchen Exp $
% $Author: jpchen $
% $Date: 2008/09/02 15:08:39 $
% $Name:  $
% $Locker:  $
% $Log: pol-he3.tex,v $
% Revision 1.27  2008/09/02 15:08:39  jpchen
% update EPR section
%
