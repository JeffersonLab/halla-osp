...
\begin{namestab}{tab:cryotarg:personnel}{Cryo Target: experts}{%
   ...
   \JianPingChen{page:584-7413}
   \JohnLeRose{page:584-7624}
   \namestabheader{JLab Cryo-Target Group} 
   \DaveMeekins{page:584-5434}
   \MikellSeely{page:584-5036}
   \ChristopherKeith{page:584-5878}
\end{namestab}
...
$\approx$ 0.003 to 0.045 $in$ thick aluminum, which are connected to a flange. 
There are usually two cells bolted on to each cell block, typically 
one 15 $cm$ long and one 4 $cm$ long. Both cells have an outer diameter of 
approximately 2 inches.
The upstream windows of the cells are made from 0.0028 $in$ thick 
aluminum.
These windows are connected 
to 1.25 $in$ diameter (0.0065 $in$ wall)
upstream window tubes with flanges which are also 
bolted on to the cell block.
