...
target cell, at a distance of about 20 meters. Before arriving in
...
display. They consist of a slider-bar with digital readback which controls
a DAC output to set the speed of the pump. A flowmeter roughly calibrated
