...
\begin{figure}[htbp]
\begin{center}
\includegraphics[angle=0,width=14cm,clip]{ber_uno}
\caption[Waterfall Target System]{The target system.}
\label{fig:uno}
\end{center}
\end{figure}

%\snfig{./figs/ber_uno.eps}{The target system}{uno}{14cm}
...
%\snfig{./figs/ber_cell1.eps}{A cutaway of the waterfall target cell}{cell1}{12cm}
\begin{figure}[htp]
\begin{center}
\includegraphics[angle=0,width=12cm,clip]{ber_cell1}
\caption[Waterfall Target: Cutaway of Target Cell]{A cutaway of the waterfall target cell.}
\label{fig:cell1}
\end{center}
\end{figure}

%\snfig{./figs/ber_fig2.eps}{Detailed view of the 3-waterfoils geometry}{cell2}{12cm}
\begin{figure}[htp]
\begin{center}
\includegraphics[angle=0,width=12cm,clip]{ber_fig2}
\caption[Waterfall Target: Three Foil Geometry]{Detailed view of the 3-waterfoils geometry.}
\label{fig:cell2}
\end{center}
\end{figure}

%\snfig{./figs/ber_fig3a.eps}{Cutaway view of the waterfall target container}{cell3a}{12cm}
\begin{figure}[htp]
\begin{center}
\includegraphics[angle=0,width=15cm,clip]{fig3a}
\caption[Waterfall Target: Target Container]{Cutaway view of the waterfall target container.}
\label{fig:cell3a}
\end{center}
\end{figure}

%\snfig{./figs/ber_fig3b.eps}{Side view of the waterfall target container}{cell3b}{12cm}
\begin{figure}[htp]
\begin{center}
\includegraphics[angle=0,width=15cm,clip]{fig3b}
...
%\snfig{./figs/ber_fig4.eps}{The Hydraulic system: a schematic view}{acqua}{10cm} 
\begin{figure}[htp]
\begin{center}
\includegraphics[angle=0,width=15cm,clip]{fig4}
...
%\snfig{./figs/ber_fig7.eps}{Schematic view of the whole system}{sette}{10cm}
\begin{figure}[htp]
\begin{center}
\includegraphics[angle=0,width=10cm,clip]{ber_fig7}
...
%\snfig{./figs/ber_fig6.eps}{Layout of the slow control system}{contro1}{10cm}
\begin{figure}[hp]
\begin{center}
\includegraphics[angle=0,width=10cm,clip]{ber_fig6}
\caption[Waterfall Target: Slow Controls]{Layout of the slow control system.}
\label{fig:control1}
\end{center}
\end{figure}
 
%\snfig{./figs/ber_fig8.eps}{Signals layout}{contro2}{13cm}
\begin{figure}[hp]
\begin{center}
\includegraphics[angle=0,width=13cm,clip]{ber_fig8}
...
\end{itemize}
% ===========  CVS info
% $Header: /group/halla/analysis/cvs/tex/osp/src/targets/Attic/waterfall_target.tex,v 1.1 2003/06/05 17:28:27 gen Exp $
% $Id: waterfall_target.tex,v 1.1 2003/06/05 17:28:27 gen Exp $
% $Author: gen $
% $Date: 2003/06/05 17:28:27 $
% $Name:  $
% $Locker:  $
% $Log: waterfall_target.tex,v $
