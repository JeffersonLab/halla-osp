...
The loud noice from the rupture could hurt
one's ears if not pretected. Therefore when the chamber is under vacuum,
protective covers are put on if possible. It needs to be takes off
for data taking. For restricted access, the protective cover is required
to be on when the chamber is in vacuum. When switching from the controlled
access to restricted access, the protective cover is required to be put on 
before the switch is taking place. Anytime when the scattering chamber
is under vacuum, the pivet area is pretected
with a loop around and a warning sign is posted that anybody goes into the
looped area, hearing protection is required.
...
% ===========  CVS info
% $Header: /group/halla/analysis/cvs/tex/osp/src/beamline/tgtcham.tex,v 1.10 2004/12/20 21:44:41 jpchen Exp $
% $Id: tgtcham.tex,v 1.10 2004/12/20 21:44:41 jpchen Exp $
% $Author: jpchen $
% $Date: 2004/12/20 21:44:41 $
% $Name:  $
% $Locker:  $
% $Log: tgtcham.tex,v $
% Revision 1.10  2004/12/20 21:44:41  jpchen
% changes according to review
%
% Revision 1.9  2004/12/15 00:12:24  gen
...
% Polishing
%
% Revision 1.4  2003/11/21 18:21:41  gen
% add reference
%
