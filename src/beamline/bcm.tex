...
\footnote{
  $CVS~revision~ $Id: bcm.tex,v 1.3 2003/06/06 15:19:02 gen Exp $ $
}
...
figure~\ref{fig:halla_bcm}.
\begin{figure}
\begin{center}
\includegraphics[angle=0,width=\textwidth,clip]{habcm_r}
{\linespread{1.}
...
For the sampled (or EPICS or Slow) data, one of the amplifier outputs is sent to a 
...
% ===========  CVS info
% $Header: /group/halla/analysis/cvs/tex/osp/src/beamline/bcm.tex,v 1.3 2003/06/06 15:19:02 gen Exp $
% $Id: bcm.tex,v 1.3 2003/06/06 15:19:02 gen Exp $
% $Author: gen $
% $Date: 2003/06/06 15:19:02 $
% $Name:  $
% $Locker:  $
% $Log: bcm.tex,v $
