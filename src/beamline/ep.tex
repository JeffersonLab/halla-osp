\section[eP Beam Energy Measurement]{eP Beam Energy Measurement
\footnote{
...
and direction of the beam. 
 \begin{figure}[htb]
    \begin{center}
        \includegraphics*[angle=0,width=0.7\textwidth]{ep_layout}
    \end{center}
    \caption[eP: Layout]{
...
Hall A MEDM graphical user interface (EPICS), which is running 
...
\mycomp{hlamain}. A screen labeled ``Hall A Main Menu'' will appear (Fig. \ref{fig:ep_hlamain}).
Chose \mycomp{LeCroy HV}, and select \mycomp{Beamline} in the screen which will pop 
up (Fig. \ref{fig:ep_hvlecroy}). 

 \begin{figure}[bht]
    \begin{center}
        \includegraphics*[angle=0,width=4cm]{ep_hlamain}
    \end{center}
    \caption[eP: hlamain]{
            Main menu of the Hall A MEDM graphical user interface. For the eP system
            the buttons LeCroy HV and EP Energy Measure are relevant.
            }
    \label{fig:ep_hlamain} 
 \end{figure}  

 \begin{figure}[bht]
    \begin{center}
        \includegraphics*[angle=0,width=4cm]{ep_lecroy}
    \end{center}
...
For a measurement, all HV channels defined in Tab. \ref{tab:ep_hv}
...
(See Fig. \ref{fig:ep_hvbeamline} - \ref{fig:ep_hvslot3})
...
It can be started from the ``Hall A Main Menu'' \infolevtwo{(Fig. \ref{fig:ep_hlamain})}
...
in Hall A (see Fig. \ref{fig:ep_pic_daq1} - \ref{fig:ep_pic_daq3} ). 
...
\paragraph{Rebooting Acquisition-VME \\ }
...
% ===========  CVS info
% $Header: /group/halla/analysis/cvs/tex/osp/src/beamline/ep.tex,v 1.3 2003/11/18 22:34:16 reitz Exp $
% $Id: ep.tex,v 1.3 2003/11/18 22:34:16 reitz Exp $
% $Author: reitz $
% $Date: 2003/11/18 22:34:16 $
% $Name:  $
% $Locker:  $
% $Log: ep.tex,v $
