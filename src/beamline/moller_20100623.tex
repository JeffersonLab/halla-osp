...
of the polarimeter. Access to the Graphical User Interface (GUI)
...
\infolevfour{
   \begin{figure}%[t]
      ...
      The object protruding towards the reader, is the target holder \& motion mechanism which slides
...
\begin{list}{$\bullet$}{\setlength{\itemsep}{-0.15cm}}
  ...
  \item ``Invasive'' preparation: beam tuning with the regular
          ...
          beam tuning, if necessary, installing the M{\o}ller target;
