...
\begin{namestab}{tab:beam:personnel}{Beam line: authorized personnel}{%
  ...
  \HariAreti{Liaison to Physics}
  \ZaferKursun{Liaison to Hall-A}
\end{namestab}
...
% ===========  CVS info
% $Header: /group/halla/analysis/cvs/tex/osp/src/beamline/beam.tex,v 1.6 2003/12/13 06:23:37 gen Exp $
% $Id: beam.tex,v 1.6 2003/12/13 06:23:37 gen Exp $
% $Author: gen $
