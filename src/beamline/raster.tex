...
safety proceedure (OSP) is being writen for it and must be reviewed and approved prior
to this systems use.

\subsection{Hazards}

The hazards of this updated system are addressed in the accomanying OSP.

\subsection{Mitigations}

The mitigations of this updated system are addressed in the accomanying OSP.
