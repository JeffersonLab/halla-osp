...
the target out of the beam.}  A % unfortunately common and 
...
plots in ESPACE or by using the stand alone code called \mycomp{spot}.
Spot is probably already running somewhere; it runs on the 
Linux or Sun computers in the counting room; if it's not
running, type \mycomp{spot}.  When a new CODA run is started,
...
% ===========  CVS info
% $Header: /group/halla/analysis/cvs/tex/osp/src/beamline/raster.tex,v 1.6 2003/12/17 03:59:47 gen Exp $
% $Id: raster.tex,v 1.6 2003/12/17 03:59:47 gen Exp $
% $Author: gen $
% $Date: 2003/12/17 03:59:47 $
% $Name:  $
% $Locker:  $
% $Log: raster.tex,v $
