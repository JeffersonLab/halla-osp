...
A new feature during the 12-GeV era are is that
the driver of the H-bridge electronics is now
an Agilent model 33522A waveform generator.
This allows us to syncrhronize the pairs of X
to within about 1 nsec; and likewise for the
pairs of Y.  Furthermore, the entire raster can
