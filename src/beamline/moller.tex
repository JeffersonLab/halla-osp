...
\label{sec:moller}
\footnote{
  $CVS~revision~ $Id: moller.tex,v 1.12 2008/04/28 15:34:33 gen Exp $ $
}
...
the water line. There are also 2-4 air fans attached by the target
...
%            events (30k at $E_{beam}<2$~GeV).
  \item[2.] Analyze the data
        \begin{list}{--}{\setlength{\itemsep}{0.cm}}
             ...
             \item[2.] \mycomp{PAW$>$~exec~asymt~run=????~angl=tang}, for each RUN,
...
% ===========  CVS info
% $Header: /group/halla/analysis/cvs/tex/osp/src/beamline/moller.tex,v 1.12 2008/04/28 15:34:33 gen Exp $
% $Id: moller.tex,v 1.12 2008/04/28 15:34:33 gen Exp $
% $Author: gen $
% $Date: 2008/04/28 15:34:33 $
% $Name:  $
% $Locker:  $
% $Log: moller.tex,v $
