...
\label{sec:moller}
\footnote{
  $CVS~revision~ $Id: moller.tex,v 1.10 2005/04/04 22:27:24 gen Exp $ $
}
...
\label{sec:moller_compon_medm}
 ...
 using the regular MEDM~\cite{MEDMwww} program of Machine Control Center (MCC). The appropriate
 window%
\infolevtwo{
...
% ===========  CVS info
% $Header: /group/halla/analysis/cvs/tex/osp/src/beamline/moller.tex,v 1.10 2005/04/04 22:27:24 gen Exp $
% $Id: moller.tex,v 1.10 2005/04/04 22:27:24 gen Exp $
% $Author: gen $
