...
\label{sec:moller}
\footnote{
  $CVS~revision~ $Id: moller.tex,v 1.9 2004/12/15 00:13:00 gen Exp $ $
}
...
\infolevtwo{
 ...
 The components are: 
 \begin{list}{--}{\setlength{\itemsep}{-0.15cm}}
   \item \mycomp{EPICS~\cite{EPICSwww} Monitor}: these EPISC variables are stored for every DAQ run
...
area. 
If a work is done on the collimators, the appropriate hearing
...
% ===========  CVS info
% $Header: /group/halla/analysis/cvs/tex/osp/src/beamline/moller.tex,v 1.9 2004/12/15 00:13:00 gen Exp $
% $Id: moller.tex,v 1.9 2004/12/15 00:13:00 gen Exp $
% $Author: gen $
% $Date: 2004/12/15 00:13:00 $
% $Name:  $
% $Locker:  $
% $Log: moller.tex,v $
