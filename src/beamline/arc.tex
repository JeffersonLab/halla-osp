...
\footnote{
  $CVS~revision~ $Id: arc.tex,v 1.5 2003/12/05 05:48:30 gen Exp $ $
}
...
% ===========  CVS info
% $Header: /group/halla/analysis/cvs/tex/osp/src/beamline/arc.tex,v 1.5 2003/12/05 05:48:30 gen Exp $
% $Id: arc.tex,v 1.5 2003/12/05 05:48:30 gen Exp $
% $Author: gen $
