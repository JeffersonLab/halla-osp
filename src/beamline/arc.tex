...
\footnote{
  $CVS~revision~ $Id: arc.tex,v 1.6 2003/12/13 06:23:37 gen Exp $ $
}
...
% ===========  CVS info
% $Header: /group/halla/analysis/cvs/tex/osp/src/beamline/arc.tex,v 1.6 2003/12/13 06:23:37 gen Exp $
% $Id: arc.tex,v 1.6 2003/12/13 06:23:37 gen Exp $
% $Author: gen $
