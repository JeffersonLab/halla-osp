...
\footnote{
  $CVS~revision~ $Id: arc.tex,v 1.7 2003/12/17 03:59:47 gen Exp $ $
}
...
% ===========  CVS info
% $Header: /group/halla/analysis/cvs/tex/osp/src/beamline/arc.tex,v 1.7 2003/12/17 03:59:47 gen Exp $
% $Id: arc.tex,v 1.7 2003/12/17 03:59:47 gen Exp $
% $Author: gen $
