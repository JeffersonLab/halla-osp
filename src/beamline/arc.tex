...
The nine dipole presents a magnetic field hazards as well as the mapper creating a mechanical
hazard as it moves.  Very high currents are also present in the magnet.

\subsection{Mitigations}

Due to the the dipole magnet and motion system, the equipment is located in a locked  shed is limited to authorized
persons which are listed in the operations manual. To be added to the list, 
...
Since the arc  requires both accelerator and physics personnal to maintain
and operate and it is very important that both groups stay in contact and that 
any work on the system be coordinated between the two groups; thus, this system
...
\begin{namestab}{tab:beam:personnel}{Beam line: authorized personnel}{%
  ...
  \DouglasHiginbotham{Physics Contact}
  \RickGonzales{Accelerator Contact}
\end{namestab}
\end{safetyen}
\infoleveqone{\clearpage}
