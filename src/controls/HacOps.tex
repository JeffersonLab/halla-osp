...
\footnote{
  $CVS~revision~ $Id: HacOps.tex,v 1.8 2003/12/05 06:10:22 gen Exp $ $
}
...
\begin{figure}[htb]
\begin{center}
  \includegraphics[angle=0,height=0.4\textheight]{medm_halla_start}
...
\begin{figure}[htb]
\begin{center}
  \includegraphics[angle=0,height=0.8\textheight]{medm_halla_tools}
...
% ===========  CVS info
% $Header: /group/halla/analysis/cvs/tex/osp/src/controls/HacOps.tex,v 1.8 2003/12/05 06:10:22 gen Exp $
% $Id: HacOps.tex,v 1.8 2003/12/05 06:10:22 gen Exp $
% $Author: gen $
% $Date: 2003/12/05 06:10:22 $
% $Name:  $
% $Locker:  $
% $Log: HacOps.tex,v $
