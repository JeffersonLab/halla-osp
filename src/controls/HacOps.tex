...
\begin{figure}[htb]
\begin{center}
\includegraphics[angle=0,width=10cm]{controls-fig1}
{\linespread{1.}
...
% ===========  CVS info
% $Header: /group/halla/analysis/cvs/tex/osp/src/controls/HacOps.tex,v 1.5 2003/11/14 22:53:00 gomez Exp $
% $Id: HacOps.tex,v 1.5 2003/11/14 22:53:00 gomez Exp $
% $Author: gomez $
% $Date: 2003/11/14 22:53:00 $
% $Name:  $
% $Locker:  $
% $Log: HacOps.tex,v $
